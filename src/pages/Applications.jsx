  ...
  return (
    <>
      ...
      <div className='flex gap-2 mb-6 mt-3'>
        {
          ...
          ?<>
              <label className='flex items-center' htmlFor="resumeUpload">
                 ...
                 <input id='resumeUpload' onChange={e => setIsResume(e.target.files[0])}accept='application/pdf' type="file" hidden />
      ...
      <table className='min-w-full bg-white border rounded-lg'>
        <thead>
          <tr>
            <th className='py-3 px-4 border-b text-left'>Company Detail</th>
